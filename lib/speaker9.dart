...
class Speaker9 extends StatelessWidget {
  Speaker9({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 188.0, end: 10.0),
            Pin(size: 47.0, middle: 0.1599),
            child: Text(
              'Heidi DiCicco',
              style: TextStyle(
          ...
          Pinned.fromPins(
            Pin(size: 100.0, middle: 0.3628),
            Pin(size: 101.2, start: 108.0),
            child:
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: const AssetImage('assets/images/speaker9.png'),
                  fit: BoxFit.fill,
                ),
              ),
            ),
                      ...
                      children: <Widget>[
                        Transform.translate(
                          ...
                          child: SizedBox(
                            ...
                            height: 881.0,
                            child: Text(
                              'Heidi DiCicco is currently the President and Chief Operating Officer of FUSE in Boca Raton, Florida, and the Secretary-Treasurer of the IACVS-Africa Charter. She brings to these roles more than 10 years of experience as an educator, an eclectic educational background, and numerous years of administrative practice. Ms. DiCicco has taught administrative law and procedures, organizational behavior, communication, mathematics, leadership, and business law all at the college level. In addition to a master’s degree in business, Ms. DiCicco is a JSD Candidate and holds a Juris Doctorate with multiple academic recognitions, including a public interest law fellowship and two book awards. She served as a court administrator and attorney for a child advocacy program and briefly as a Senior Attorney for Florida’s Office of the Attorney General, Children’s Legal Services. Ms. DiCicco also previously was a Department Director for a nonprofit.',
                              style: TextStyle(
                                fontFamily: 'Montserrat',
                                fontSize: 18,
...
const String _svg_gt1j8 =
    '<svg viewBox="238.0 228.1 162.0 1.0" ><path transform="translate(238.0, 228.08)" d="M 162 0 L 0 0.5" fill="none" stroke="#707070" stroke-width="2" stroke-opacity="0.13" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
