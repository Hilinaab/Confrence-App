...
class Speaker6 extends StatelessWidget {
  Speaker6({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 168.0, end: 26.0),
            Pin(size: 48.0, middle: 0.1993),
            child: Text(
              'Speaker',
              style: TextStyle(
                fontFamily: 'Montserrat',
            ...
            child:
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: const AssetImage('assets/images/speaker6.png'),
                  fit: BoxFit.fill,
                ),
              ),
            ),
                      ...
                      children: <Widget>[
                        Transform.translate(
                          ...
                          child: SizedBox(
                            ...
                            height: 659.0,
                            child: Text(
                              'Philippe Dubois has an advanced background in finance and obtained his Master of Science degree in Finance from Florida Atlantic University (FAU). He has extensive experience in operations management, finance leadership, and strategy in the technology, banking, and energy industries. Mr. Dubois raised money and interfaced with Wall Street, and held upper-management level positions at a Fortune 500 company and a major international bank. He also served as a Financial Analyst for the only Haitian international investment group, GB Group. Philippe is an Associate Director at FAU and currently is enrolled in FAU’s Executive PhD program at the College of Business.',
                              style: TextStyle(
                                fontFamily: 'Montserrat',
                                fontSize: 18,
...
const String _svg_h2holb =
    '<svg viewBox="240.0 215.0 162.0 1.0" ><path transform="translate(240.0, 215.0)" d="M 162 0 L 0 0.5" fill="none" stroke="#707070" stroke-width="2" stroke-opacity="0.13" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
